              ...
              <form>
                  ...
                  <div className="col">
                    <div className="row align-items-center">
                      <div className="col-md-7">
                        <h4 className="mb-1">Raj Verma</h4>
                        {/* <p class="small mb-3"><span class="badge badge-dark">Bandra West, India</span></p> */}
                      </div>
                    </div>
                    <div className="row mb-4">
                      ...
                      <div className="col-md-7">
                        <p className="small mb-0 text-muted">Linking Road</p>
                        <p className="small mb-0 text-muted">
                          Bandra West, India
                        </p>
                        <p className="small mb-0 text-muted">8809657884</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="inputEmail4"
                    placeholder="rajverma12@gmail.com"
                  />
                </div>
                <div className="form-group">
